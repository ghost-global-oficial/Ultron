...
export async function applyAuthChoiceApiProviders(
  ...
  if (authChoice === "groq-api-key") {
    ...
    const GROQ_DEFAULT_MODEL = "groq/llama-3.3-70b-versatile";
    const applied = await applyDefaultModelChoice({
      config: nextConfig,
      setDefaultModel: params.setDefaultModel,
      ...
      applyDefaultConfig: (cfg) => {
        ...
        models[GROQ_DEFAULT_MODEL] = { alias: "Groq Llama 3" };
        return {
          ...cfg,
          agents: {
            ...cfg.agents,
            defaults: { ...cfg.agents?.defaults, models, model: { primary: GROQ_DEFAULT_MODEL } },
          },
        };
      },
