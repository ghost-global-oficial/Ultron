...
export async function runOnboardingWizard(
  ...
  // Always prompt for model selection when an auth provider is chosen, 
  // as requested by the user for the Ultron project.
  if (authChoice !== "skip") {
    const modelSelection = await promptDefaultModel({
      ...
      message: "Escolha o modelo de IA para este provedor",
    });
